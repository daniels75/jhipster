...
import org.jhipster.org.repository.TodoRepository;
...
public class TodoResourceIT {
    ...
    public void createTodo() throws Exception {
        ...
        assertThat(testTodo.isComplete()).isEqualTo(DEFAULT_COMPLETE);
    }
    ...
    public void updateTodo() throws Exception {
        ...
        assertThat(testTodo.isComplete()).isEqualTo(UPDATED_COMPLETE);
    }
